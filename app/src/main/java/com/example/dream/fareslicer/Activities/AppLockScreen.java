...
//        user_password="1234"; remove
        ...
        set_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(AppLockScreen.this, "Enter new password", Toast.LENGTH_SHORT).show();
                }
                else {
...
//        forgot_password.setVisibility(View.GONE);  change
        password_heading=findViewById(R.id.tv_hint_msg);
    ...
    private void showAlertDialog() {
        ...
        builder.setTitle("Ooops! No Internet connection");
    ...
    private void passwordConditionCheck(Boolean pass) {
        ...
        if(pass == true) {
            ...
            if (getIntent().getStringExtra("from").equalsIgnoreCase("splash")) {
                ...
                Toast.makeText(AppLockScreen.this, "Change password", Toast.LENGTH_SHORT).show();
                set=4;
                password_heading.setText(R.string.old_password);
    ...
    private void passwordSettingFunction() {
        ...
        else if(set ==1) //password typed here is checked with the temporary variable and if true password is saved
        {
            ...
            {
                Toast.makeText(AppLockScreen.this, "Password doesn't match", Toast.LENGTH_SHORT).show();
        ...
        else if (set==3) //here we check whether already set password and this password is equal or not
        {
            ...
            {
                Intent intent=new Intent(AppLockScreen.this,Home.class);
                startActivity(intent);
                finish();
            }
            else
            {
                Toast.makeText(AppLockScreen.this, "Incorrect Password", Toast.LENGTH_SHORT).show();
                    ...
                    if (selectResult != null) {
                        ...
                        else
                        {
                            ...
                            if(type.equalsIgnoreCase("update"))
                            {
                                ...
                                Intent intent=new Intent(AppLockScreen.this,AppLockScreen.class);
...
//                                Toast.makeText(AppLockScreen.this, "pass"+user_password, Toast.LENGTH_SHORT).show();
                            }
...
//                Toast.makeText(NewGroup.this, "Insertion Call failed", Toast.LENGTH_SHORT).show();
    ...
    private void forgotPasswordFunction() {
        ...
        {
            Toast.makeText(AppLockScreen.this, "No email id found", Toast.LENGTH_SHORT).show();
        }
        else {
                ...
                if(response.code()==200) {
                    ...
                    if (selectResult != null) {
                        ...
                        if (success.equalsIgnoreCase("true")) {
                            ...
                            Intent intent=new Intent(AppLockScreen.this,ForgotPassword.class);
                            startActivity(intent);
                            finish();
